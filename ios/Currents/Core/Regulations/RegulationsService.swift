...
final class RegulationsService {
    ...
    private static let embedded: [FishingRegulation] = [
        ...
        .init(scientificName: "Dichistius capensis", commonName: "Galjoen", region: "South Africa",
              minSizeCm: 35, maxSizeCm: nil, bagLimit: 2, closedSeason: "Closed 15 Oct – 28 Feb",
              notes: "SA national fish. Min 35 cm, bag 2, closed in summer spawning season."),
        .init(scientificName: "Pomadasys commersonnii", commonName: "Spotted Grunter", region: "South Africa",
              minSizeCm: 40, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: "Min 40 cm, bag 5."),
        .init(scientificName: "Pachymetopon grande", commonName: "Bronze Bream", region: "South Africa",
              minSizeCm: 30, maxSizeCm: nil, bagLimit: 2, closedSeason: nil, notes: "Reef species — min 30 cm, bag 2."),
        .init(scientificName: "Diplodus hottentotus", commonName: "Zebra", region: "South Africa",
              minSizeCm: 30, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: nil),
        .init(scientificName: "Cheimerius nufar", commonName: "Santer", region: "South Africa",
              minSizeCm: 30, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: nil),
        .init(scientificName: "Chrysoblephus puniceus", commonName: "Slinger", region: "South Africa",
              minSizeCm: 25, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: nil),
        .init(scientificName: "Petrus rupestris", commonName: "Red Steenbras", region: "South Africa",
              minSizeCm: 60, maxSizeCm: nil, bagLimit: 1, closedSeason: nil,
              notes: "Slow-growing, heavily depleted — one per day, min 60 cm."),
        .init(scientificName: "Polysteganus undulosus", commonName: "Seventy-four", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 0, closedSeason: nil,
              notes: "No-take — protected. Release all Seventy-four."),
        .init(scientificName: "Atractoscion aequidens", commonName: "Geelbek / Cape Salmon", region: "South Africa",
              minSizeCm: 60, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: "Min 60 cm, bag 5."),
        .init(scientificName: "Thyrsites atun", commonName: "Snoek", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: "Bag limit 10."),
        .init(scientificName: "Pachymetopon blochii", commonName: "Hottentot", region: "South Africa",
              minSizeCm: 22, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: nil),
        .init(scientificName: "Pterogymnus laniarius", commonName: "Panga", region: "South Africa",
              minSizeCm: 20, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: nil),
        .init(scientificName: "Genypterus capensis", commonName: "Kingklip", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 1, closedSeason: nil, notes: "Bag limit 1."),
        .init(scientificName: "Rhabdosargus sarba", commonName: "Natal Stumpnose", region: "South Africa",
              minSizeCm: 25, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: nil),
        .init(scientificName: "Scomberomorus commerson", commonName: "King Mackerel (Couta)", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: "Bag limit 10 (per person)."),
        .init(scientificName: "Coryphaena hippurus", commonName: "Dorado (Dolphinfish)", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: "Bag limit 10."),
        .init(scientificName: "Chrysoblephus anglicus", commonName: "Englishman", region: "South Africa",
              minSizeCm: 40, maxSizeCm: nil, bagLimit: 1, closedSeason: nil, notes: "One per day, min 40 cm."),
        .init(scientificName: "Chrysoblephus cristiceps", commonName: "Dageraad", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 1, closedSeason: nil, notes: "One per day — depleted reef species."),
        .init(scientificName: "Umbrina robinsoni", commonName: "Baardman / Belman", region: "South Africa",
              minSizeCm: 40, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: nil),
        .init(scientificName: "Lithognathus mormyrus", commonName: "Sand Steenbras", region: "South Africa",
              minSizeCm: 20, maxSizeCm: nil, bagLimit: 10, closedSeason: nil, notes: nil),
        .init(scientificName: "Lithognathus lithognathus", commonName: "White Steenbras (Pignose)", region: "South Africa",
              minSizeCm: 60, maxSizeCm: nil, bagLimit: 1, closedSeason: "Closed 1 Oct – 30 Nov",
              notes: "One per day, min 60 cm, seasonal closure — heavily depleted."),
        .init(scientificName: "Argyrosomus inodorus", commonName: "Silver Kob", region: "South Africa",
              minSizeCm: 60, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: "Min 60 cm, bag 5."),
        .init(scientificName: "Epinephelus marginatus", commonName: "Yellowbelly Rockcod", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 1, closedSeason: nil, notes: "One per day — slow growing."),
        .init(scientificName: "Trachinotus botla", commonName: "Largespot Pompano (Wave Garrick)", region: "South Africa",
              minSizeCm: nil, maxSizeCm: nil, bagLimit: 5, closedSeason: nil, notes: nil),
    ]
}
